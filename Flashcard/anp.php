...
<div class="main-content">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      {
        question: "The smallest functional unit of the kidney is called the:",
        answer: "Nephron"
      },
      {
        question: "The process by which cells divide to produce two identical daughter cells is called:",
        answer: "Mitosis"
      },
      {
        question: "The bony structure that supports the brain is the",
        answer: "Cranium"
      },
      {
        question: "The functional unit of the lung where gas exchange occurs is the:",
        answer: "Alveoli"
      },
      {
        question: "The primary function of the endocrine system is to:",
        answer: "Secrete hormones to regulate body functions"
      },
      {
        question: "The region of the brain that controls higher cognitive functions such as thinking and planning is the:",
        answer: "Brainstem"
      },
      {
        question: "The process by which oxygen diffuses from the alveoli into the blood is known as:",
        answer: "Diffusion"
      },
      {
        question: "What blood vessel does oxygenated blood leave the heart?",
        answer: "Aorta"
      },
      {
      ...
      },
      {
        ...
        answer: "To store and release calcium ions (Ca²⁺) during muscle contraction."
      },
      {
        question: "Which part of the brainstem controls basic life functions such as breathing, heart rate, and blood pressure?",
        answer: "Medulla oblongata"
      },
      {
        question: "What type of joint is found between the femur and pelvis?",
        answer: "Ball-and-socket joint"
      },
      {
        question: "What are the three layers of the heart wall (from outermost to innermost)?",
        answer: "Epicardium, myocardium, endocardium"
      },
      {
        question: "Which hormone regulates the metabolic rate by stimulating almost every tissue in the body?",
        answer: "Thyroxine (T₄), produced by the thyroid gland"
      }
            ];
