  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const originalFlashcards = [
        {
          question: "Bioethical decision-making in nursing should be based on:",
          answer: "Core ethical principles and patient-centered care"
        },
        {
          question: "The ethical principle of non-maleficence means:",
          answer: "Avoid causing harm to patients."
        },
        {
          question: "When a nurse supports a terminally ill patient’s decision to refuse treatment, it demonstrates:",
          answer: "Autonomy"
        },
        {
          question: "If a nurse accidentally harms a patient and reports the incident honestly, what principle is upheld?",
          answer: "Veracity"
        },
        {
          question: "Informed consent is most closely associated with what ethical principle?",
          answer: "Autonomy"
        },
        {
          question: "A nurse refusing to reveal a patient’s personal health information without consent is practicing what principle?",
          answer: "Confidentiality"
        },
        {
          question: "What principle of bioethics is concerned with fairness in the distribution of healthcare resources?",
          answer: "Justice"
        },
        {
          question: "The principle of fidelity refers to:",
          answer: "Keeping promises and being loyal to patients"
        },
        {
          question: "Telling the truth to a patient, even when the news is difficult, is an example of:",
          answer: "Veracity"
        },
        {
          question: "When a nurse advocates for a patient who is being discharged prematurely, what ethical principle is being demonstrated?",
          answer: "Advocacy"
        },
        {
          question: "What ethical principle is primarily concerned with protecting a patient's right to make their own healthcare decisions?",
          answer: "Autonomy"
        },
        {
          question: "Which bioethical principle refers to the obligation to do good and promote the well-being of patients?",
          answer: "Beneficence"
        },
        {
          question: "What principle is being violated if a healthcare professional withholds information from a patient without a valid reason?",
          answer: "Veracity (Truthfulness)"
        },
        {
          question: "In what situation might a nurse ethically breach patient confidentiality?",
          answer: "When there is a duty to warn or protect others from harm (e.g., threat of violence or communicable diseases)"
        },
        {
          question: "What is the term for the ethical concept where treatment is withheld or withdrawn because it offers no benefit to the patient?",
          answer: "Medical futility"
        }
            ];
