  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const originalFlashcards = [
        {
          question: "What is the term for excessive nausea and vomiting during pregnancy that may lead to dehydration?",
          answer: "Hyperemesis Gravidarum"
        },
        {
          question: "What is the term for the first fetal stool that is passed within 24-48 hours after birth?",
          answer: "Meconium"
        },
        {
          question: "What is the most common fetal heart rate pattern associated with umbilical cord compression?",
          answer: "Variable decelerations"
        },
        {
          question: "What assessment tool is used to determine fetal well-being by measuring fetal heart rate accelerations in response to fetal movements?",
          answer: "Non-Stress Test (NST)"
        },
        {
          question: "What hormone is responsible for uterine contractions during labor?",
          answer: "Oxytocin"
        },
        {
          question: "The medical term for difficulty in swallowing",
          answer: "Dysphagia"
        },
        {
          question: "The study of poisonous substance and their effects on the body",
          answer: "Toxicology"
        },
        {
          question: "The excessive accumulation of body fat leading to increased health risks",
          answer: "Obesity"
        },
        {
          question: "The Period from conception to birth, usually lasting about 280 days or 40 weeks",
          answer: "Gestation"
        },
        {
          question: "The fine, soft hair that covers the body of a fetus and is usually shed before birth",
          answer: "Lanugo"
        }
      ];
